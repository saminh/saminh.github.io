! function(e) {
    ...
    var _e, me, ye, ve, be, ge, Ee, we = function(e) {
            function t(e) {
                r(this, t);
        ...
        Oe = n(2),
        Pe = n.n(Oe),
        Ae = window.Promise ? Promise : Pe.a,
        Te = Ae,
        Ie = ("function" == typeof Symbol && Symbol.iterator, function(e, t) {
        ...
        xe = function(e) {
            return /^pk_test_/.test(e) ? De.test : /^pk_live_/.test(e) ? De.live : De.unknown
        },
        Fe = function(e) {
            if (e === De.unknown) throw new Se("It looks like you're using an older Stripe key. In order to use this API, you'll need to use a modern API key, which is prefixed with 'pk_live_' or 'pk_test_'.\n    You can roll your publishable key here: https://dashboard.stripe.com/account/apikeys")
        },
        ...
        Ve = function(e, t) {
            return function(n, r) {
                var o = function(e) {
                    ...
                    i = function(e, t, n) {
                        return Ye(new Se("Invalid value for " + e + ": " + t + ". You specified " + n + "."))
                    },
                    a = e(n, r),
                    s = t(n, r);
        ...
        Qe = function(e) {
            return function(t, n) {
                return "string" == typeof t && 0 === t.indexOf(e) ? ze(t) : We("a string starting with " + e, t, n)
            }
        },
        $e = function() {
        ...
        Ze = $e.apply(void 0, s(qe)),
        et = $e.apply(void 0, s(Me)),
        tt = ($e.apply(void 0, s(Object.keys(De))), function(e, t) {
            return "string" == typeof e ? ze(e) : We("a string", e, t)
        }),
        nt = function(e, t) {
            return function(n, r) {
        ...
        rt = function(e, t) {
            return "boolean" == typeof e ? ze(e) : We("a boolean", e, t)
        },
        ot = function(e, t) {
            return "number" == typeof e ? ze(e) : We("a number", e, t)
        },
        it = function(e) {
            return function(t, n) {
                return "number" == typeof t && t > e ? ze(t) : We("a number greater than " + e, t, n)
            }
        },
        at = function(e) {
            return function(t, n) {
                return "number" == typeof t && t === parseInt(t, 10) && (!e || t >= 0) ? ze(t) : We(e ? "a positive amount in the currency's subunit" : "an amount in the currency's subunit", t, n)
            }
        },
        st = function(e, t) {
            return at(!1)(e, t)
        ...
        ut = function(e, t) {
            return e && "object" === (void 0 === e ? "undefined" : Ue(e)) ? ze(e) : We("an object", e, t)
        },
        lt = function(e) {
            return function(t, n) {
                if (Array.isArray(t)) {
                    ...
                    if (Array.isArray(n)) {
                        ...
                        if ("valid" === o.type)
                            for (var i = {}, a = 0; a < o.value.length; a += 1) {
                                var s = o.value[a];
                                if ("object" === (void 0 === s ? "undefined" : Ue(s)) && s && "string" == typeof s[e]) {
                                    var c = s[e];
                                    if (i[c]) return Ye(new Se("Duplicate value for " + e + ": " + c + ". The property '" + e + "' of '" + r.path.join(".") + "' has to be unique."));
                                    i[c] = !0
                                }
                            }
                        return o
        ...
        dt = function(e) {
            return function(t, n) {
                return void 0 === t ? ze(void 0) : We("used in " + e + " instead", t, n)
            }
        },
        ft = function(e) {
            return function(t) {
                return function(n, r) {
                    if (n && "object" === (void 0 === n ? "undefined" : Ue(n)) && !Array.isArray(n)) {
                        var o = n,
                            i = Ie(Object.keys(o), function(e) {
                                return !t[e]
                            });
                        if (i && e) return Ye(new Se("Invalid " + r.label + " parameter: " + [].concat(s(r.path), [i]).join(".") + " is not an accepted parameter."));
                        var c = Object.keys(o),
                            u = ze({});
                        return i && (u = c.reduce(function(e, n) {
                            ...
                            return "valid" === c.type && void 0 !== c.value ? ze(Be({}, e.value, a({}, n, c.value)), [].concat(s(e.warnings), s(c.warnings))) : "valid" === c.type ? ze(e.value, [].concat(s(e.warnings), s(c.warnings))) : c
                        }, u)
                    }
                    return We("an object", n, r)
                }
            }
        },
        ht = ft(!0),
        ...
        mt = function(e, t, n, r) {
            ...
            return "valid" === i.type ? i : "full" === i.errorType ? i : {
                type: "error",
                errorType: "full",
                error: new Se(He(i.expected, i.actual, i.options))
            }
        },
        yt = function(e, t, n, r) {
            var o = mt(e, t, n, r);
        ...
        Ot = Object({
            ...
            CARDINAL_INNER_HTML_NAME: "cardinal-inner-d7a04728b790f809df60f404fb6b2349.html",
            THREE_DS_2_FINGERPRINT_HTML_NAME: "three-ds-2-fingerprint-68dbae7af35bc4efc1973ba0bd38c7b5.html",
            THREE_DS_2_CHALLENGE_HTML_NAME: "three-ds-2-challenge-722b2b04c07b6a8023322c6e50fd8451.html",
            AUTHORIZE_WITH_URL_INNER_HTML_NAME: "authorize-with-url-inner-325162b4c721e6a1ad768a800b2078b5.html",
            PAYMENT_REQUEST_INNER_GOOGLE_PAY_HTML_NAME: "payment-request-inner-google-pay-0f99fe3965327ddff4c40467295b587f.html",
            PAYMENT_REQUEST_INNER_BROWSER_HTML_NAME: "payment-request-inner-browser-40686a512b9d2933def4816982fc2282.html",
            CONTROLLER_HTML_NAME: "controller-468c9b0e9c4af4a3b6bf50577a4604fe.html",
            RECAPTCHA_HTML_NAME: "recaptcha.html",
            ELEMENTS_INNER_FPX_BANK_HTML_NAME: "elements-inner-fpx-bank.html",
            ELEMENTS_INNER_AU_BANK_ACCOUNT_HTML_NAME: "elements-inner-au-bank-account-6c8b1a5bdc0adeb95da63ef21046e668.html",
            ELEMENTS_INNER_PAYMENT_REQUEST_HTML_NAME: "elements-inner-payment-request-d135de1bb7f8986cd75723be5fb63fd9.html",
            ELEMENTS_INNER_IDEAL_BANK_HTML_NAME: "elements-inner-ideal-bank-f0bef42d3afc60116d092b1e1668292d.html",
            ELEMENTS_INNER_IBAN_HTML_NAME: "elements-inner-iban-2146d29459e7cbc91aa1adc8ebf11384.html",
            ELEMENTS_INNER_CARD_HTML_NAME: "elements-inner-card-c70a2a9e22fb5d806d378ccffefa7aad.html",
            STRIPE_JS_NO_DEMOS: "1",
            STRIPE_JS_NO_REPORTS: "1"
        }),
        Pt = function(e) {
            return "" + (Ot.STRIPE_JS_ROOT_URL || "") + (e || "")
        },
        At = function(e) {
            switch (e) {
                case "CARD_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_CARD_HTML_NAME);
                case "CONTROLLER":
                    return Pt(Ot.CONTROLLER_HTML_NAME);
                case "METRICS_CONTROLLER":
                    return "https://js.stripe.com/v2/m/outer.html";
                case "PAYMENT_REQUEST_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_PAYMENT_REQUEST_HTML_NAME);
                case "PAYMENT_REQUEST_BROWSER":
                    return Pt(Ot.PAYMENT_REQUEST_INNER_BROWSER_HTML_NAME);
                case "PAYMENT_REQUEST_GOOGLE_PAY":
                    return Pt(Ot.PAYMENT_REQUEST_INNER_GOOGLE_PAY_HTML_NAME);
                case "IBAN_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_IBAN_HTML_NAME);
                case "IDEAL_BANK_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_IDEAL_BANK_HTML_NAME);
                case "AUTHORIZE_WITH_URL":
                    return Pt(Ot.AUTHORIZE_WITH_URL_INNER_HTML_NAME);
                case "CARDINAL_3DS2":
                    return Pt(Ot.CARDINAL_INNER_HTML_NAME);
                case "STRIPE_3DS2_CHALLENGE":
                    return Pt(Ot.THREE_DS_2_CHALLENGE_HTML_NAME);
                case "STRIPE_3DS2_FINGERPRINT":
                    return Pt(Ot.THREE_DS_2_FINGERPRINT_HTML_NAME);
                case "AU_BANK_ACCOUNT_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_AU_BANK_ACCOUNT_HTML_NAME);
                case "FPX_BANK_ELEMENT":
                    return Pt(Ot.ELEMENTS_INNER_FPX_BANK_HTML_NAME);
                default:
                    return ke(e)
            }
        },
        ...
        Ct = Nt,
        jt = [Rt.card, Rt.cardNumber, Rt.cardExpiry, Rt.cardCvc, Rt.postalCode],
        Mt = jt,
        Lt = gt("https://js.stripe.com/v3/"),
        qt = Lt ? Lt.origin : "",
        Dt = {
            family: "font-family",
            src: "src",
        ...
        xt = Object.keys(Dt).reduce(function(e, t) {
            return e[Dt[t]] = t, e
        }, {}),
        Ft = [Rt.idealBank, Rt.idealBankSecondary, Rt.fpxBank, Rt.fpxBankSecondary],
        Bt = 0,
        Ut = function(e) {
            return "" + e + Bt++
        },
        ...
        Yt = function e(t, n) {
            ...
            return Object.keys(t).forEach(function(o) {
                var i = t[o],
                    a = n ? n + "[" + o + "]" : o;
                if (i && "object" === (void 0 === i ? "undefined" : zt(i))) {
                    var s = e(i, a);
                    "" !== s && (r = [].concat(c(r), [s]))
        ...
        Xt = function(e) {
            if (!document.body) throw new Se("Stripe.js requires that your page has a <body> element.");
        ...
        en = function(e) {
            var t = e.frameId,
                ...
                o = qt,
                i = void 0;
            "controller" === r ? i = $t(t) : "group" === r ? i = $t(n) : "outer" === r ? i = window.frames[t] : "inner" === r && (o = "*", i = window.parent), i && i.postMessage(JSON.stringify(Zt({}, e, {
                __stripeJsV3: !0
            })), o)
        },
        tn = function(e) {
        ...
        un = function e() {
            ...
            u(this, e), this._emit = function(e) {
                ...
                if ("string" != typeof e) throw new Se("When adding an event listener, the first argument should be a string event name.");
                if ("function" != typeof n) throw new Se("When adding an event listener, the second argument should be a function callback.");
            ...
            var n = an(this._userOn),
                r = an(this._off),
                o = an(this._once),
                i = on(this._hasRegisteredListener),
                a = on(this._removeAllListeners),
                s = cn(this._emit);
        ...
        fn = function(e) {
            ...
            return f(t, e), dn(t, [{
                ...
                value: function(e) {
                    ...
                    this._persistentMessages = [].concat(l(this._persistentMessages), [t]), this.loaded && en(t)
                }
            }, {
                key: "resolve",
                value: function(e, t) {
                ...
                key: "_send",
                value: function(e) {
                    this._ensureMounted(), this.loaded ? en(e) : this._queuedMessages = [].concat(l(this._queuedMessages), [e])
                }
            }, {
                key: "appendTo",
                value: function(e) {
                ...
                value: function(e) {
                    var t = window.location.href.toString(),
                        n = gt(t),
                        r = n ? n.origin : "",
                        o = e.queryString && "string" == typeof e.queryString ? e.queryString : Gt(pn({}, e, {
                            origin: r,
                            referrer: t,
                            controllerId: this._controllerId
                        })),
                        i = document.createElement("iframe");
                    return i.setAttribute("frameborder", "0"), i.setAttribute("allowTransparency", "true"), i.setAttribute("scrolling", "no"), i.setAttribute("name", this.id), i.setAttribute("allowpaymentrequest", "true"), i.src = Tt(this.type) + "#" + o, i
                }
            }]), t
        }(ln),
        hn = fn,
        ...
        vn = function(e) {
            ...
            return m(t, e), _n(t, [{
                key: "_ensureMounted",
                value: function() {
                    mn(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_ensureMounted", this).call(this), this._isMounted() || this._autoMount()
                }
            }, {
                key: "_autoMount",
                value: function() {
                    if (document.body) this.appendTo(document.body);
                    else if ("complete" === document.readyState || "interactive" === document.readyState) throw new Se("Stripe.js requires that your page has a <body> element.");
                    this.autoload && (this.loaded = !0)
                }
            }, {
                key: "_createIFrame",
                value: function(e) {
                    var n = mn(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_createIFrame", this).call(this, e);
                    return n.setAttribute("aria-hidden", "true"), n.setAttribute("allowpaymentrequest", "true"), n.setAttribute("tabIndex", "-1"), Qt(n, yn), n
                }
            }]), t
        }(hn),
        bn = vn,
        ...
        Pn = function(e) {
            ...
            return w(t, e), Sn(t, [{
                ...
                value: function(e) {
                    ...
                    return n.setAttribute("title", "Secure payment input frame"), Qt(n, On), n
                }
            }]), t
        }(hn),
        An = Pn,
        ...
        Rn = function() {
            return Xt(function(e) {
                ...
                return e.style.position = "fixed", e.style.overflow = "hidden", document.documentElement && (document.documentElement.style.overflow = "visible"), e.style.top = -d + "px", e.style.left = -p + "px", e.style.right = f + "px", e.style.bottom = h + "px", In(function() {
                    e.style.position = n, e.style.top = r, e.style.left = o, e.style.bottom = i, e.style.right = a, e.style.overflow = s, document.documentElement && (document.documentElement.style.overflow = u), window.scrollTo(p, d)
                })
            })
        },
        Nn = function(e, t) {
        ...
        Cn = function(e) {
            var t = [],
                n = Ce(document.querySelectorAll("*"), function(n) {
        ...
        qn = function e(t) {
            ...
            S(this, e), this.domElement = document.createElement("div"), this._runOnHide = [], this.mount = function() {
                ...
                if (Qt(n.domElement, Mn), n._lockScrolling) {
                    var e = Rn();
                    n._runOnHide.push(e)
                }
                if (n._lockFocus) {
                    var t = Cn(n._lockFocusOn);
                    n._runOnHide.push(t)
                }
                ...
                return new Te(function(e) {
                    Qt(n.domElement, Mn), setTimeout(e, 500), n.domElement.addEventListener("transitionend", e)
                }).then(function() {
        ...
        Bn = function(e) {
            function t(e, n, r) {
                ...
                return o._autoMount = function() {
                    ...
                    o._backdrop.show(), Qt(o._iframe, Fn)
                    ...
                    return o.fadeOutBackdrop().then(function() {
                        o._backdrop.unmount(), xn(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "destroy", o).call(o)
                    })
                }, o._backdrop = new Dn({
                    lockScrolling: !0,
                    lockFocus: !0,
        ...
        Wn = function(e) {
            ...
            return I(t, e), zn(t, [{
                ...
                key: "_createIFrame",
                value: function(e) {
                    var n = Yn(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_createIFrame", this).call(this, Hn({}, e, {
                        isSecondaryFrame: !0
                    }));
                    return Qt(n, Gn), n.style.height = "0", n
                }
            }]), t
        }(hn),
        Kn = Wn,
        ...
        Qn = function(e) {
            return Jn(e, "https://js.stripe.com/v3/")
        },
        $n = function(e) {
            return Qn(e) || Vn(e)
        },
        Xn = ["button", "checkbox", "file", "hidden", "image", "submit", "radio", "reset"],
        Zn = function(e) {
            var t = e.tagName;
            if (e.isContentEditable || "TEXTAREA" === t) return !0;
            if ("INPUT" !== t) return !1;
            var n = e.getAttribute("type");
            return -1 === Xn.indexOf(n)
        },
        er = Zn,
        tr = function(e) {
        ...
        or = function(e) {
            return /iPad|iPhone/i.test(e) && !nr(e)
        },
        ir = function(e) {
            return /Android/i.test(e) && !nr(e)
        },
        ar = window.navigator.userAgent,
        sr = tr(ar),
        cr = (function(e) {
        ...
        pr = (function(e) {
            ...
            /Android 4\./i.test(e) && !/Chrome/i.test(e) && ir(e)
        }(ar), function(e) {
            return /^((?!chrome|android).)*safari/i.test(e) && !rr(e)
        }(ar)),
        dr = (function(e) {
            /Firefox\//i.test(e)
        }(ar), function(e) {
        ...
        fr = (function(e) {
            ...
            return /AppleWebKit/i.test(e) && !/Chrome/i.test(e) && !tr(e) && !nr(e)
        }(ar)),
        hr = function(e) {
            return /Chrome/i.test(e) && !tr(e)
        }(ar),
        _r = (_e = {}, R(_e, Rt.card, {
            unique: !0,
            conflict: [Rt.cardNumber, Rt.cardExpiry, Rt.cardCvc, Rt.postalCode],
            beta: !1
        }), R(_e, Rt.cardNumber, {
            unique: !0,
            conflict: [Rt.card],
        ...
        mr = _r,
        yr = (me = {}, N(me, Rt.card, kt.CARD_ELEMENT), N(me, Rt.cardNumber, kt.CARD_ELEMENT), N(me, Rt.cardExpiry, kt.CARD_ELEMENT), N(me, Rt.cardCvc, kt.CARD_ELEMENT), N(me, Rt.postalCode, kt.CARD_ELEMENT), N(me, Rt.paymentRequestButton, kt.PAYMENT_REQUEST_ELEMENT), N(me, Rt.iban, kt.IBAN_ELEMENT), N(me, Rt.idealBank, kt.IDEAL_BANK_ELEMENT), N(me, Rt.auBankAccount, kt.AU_BANK_ACCOUNT_ELEMENT), N(me, Rt.fpxBank, kt.FPX_BANK_ELEMENT), me),
        vr = yr,
        br = ["brand"],
        gr = ["country", "bankName"],
        Er = ["bankName", "branchName"],
        wr = (ye = {}, C(ye, Rt.card, br), C(ye, Rt.cardNumber, br), C(ye, Rt.iban, gr), C(ye, Rt.auBankAccount, Er), ye),
        Sr = (ve = {}, C(ve, Rt.idealBank, {
            secondary: Rt.idealBankSecondary
        }), C(ve, Rt.fpxBank, {
            secondary: Rt.fpxBankSecondary
        }), ve),
        ...
        Tr = function(e) {
            return "object" === (void 0 === e ? "undefined" : Or(e)) && null !== e && "IntegrationError" === e.name ? new Se("string" == typeof e.message ? e.message : "") : e
        },
        Ir = function e(t) {
            M(this, e), Rr.call(this);
            var n = t.apiKey,
                r = t.stripeAccount,
                o = t.stripeJsId,
                i = t.locale;
            this._id = Ut("__privateStripeController"), this._stripeJsId = o, this._apiKey = n, this._stripeAccount = r, this._controllerFrame = new wn(kt.CONTROLLER, this._id, kr({}, t)), this._frames = {}, this._requests = {}, this._setupPostMessage(), this._handleMessage = on(this._handleMessage, this), this.action.fetchLocale({
                locale: i || "auto"
            })
        },
        Rr = function() {
            ...
            this._sendCAReq = function(t) {
                ...
                var r = n.groupId,
                    o = j(n, ["groupId"]),
                    i = new An(t, e._id, kr({}, o, {
                        keyMode: xe(e._apiKey)
                    }));
                ...
                if (n === e._id) switch (o.action) {
                    ...
                    case "stripe-frame-action-error":
                        i && i.reject(o.payload.nonce, Tr(o.payload.faErr));
                        break;
                    case "stripe-frame-error":
                        throw new Se(o.payload.message);
                    ...
                    case "stripe-safe-controller-action-error":
                        e._requests[o.payload.nonce] && e._requests[o.payload.nonce].reject(Tr(o.payload.caErr))
                }
            }
        },
        Nr = Ir,
        ...
        jr = function(e) {
            Cr().match(/width=device-width/) || e('Elements requires "width=device-width" be set in your page\'s viewport meta tag.\n       For more information: https://stripe.com/docs/stripe-js/elements/quickstart#viewport-meta-requirements')
        },
        Mr = {
        ...
        Ur = function(e) {
            return Object.keys(Br).forEach(function(t) {
                e.setRequestHeader(t, Br[t])
            }), e
        },
        Hr = function e(t) {
            return new Te(function(n, r) {
                var o = t.method,
                    ...
                    s = t.withCredentials,
                    c = a ? Gt(a) : "",
                    u = !window.XMLHttpRequest || Et(i) && void 0 === (new XMLHttpRequest).withCredentials,
                    l = "GET" === o && c ? i + "?" + c : i,
                    p = "GET" === o ? "" : c;
                if (u) {
                    ...
                    s && (f.withCredentials = s), f.open(o, l, !0), Ur(f), f.onreadystatechange = function() {
                        4 === f.readyState && (f.onreadystatechange = function() {}, 0 === f.status ? s ? r(new xr) : e(Fr({}, t, {
                            withCredentials: !0
                        })).then(n, r) : n(f))
                    };
                    try {
        ...
        Gr = function(e, t) {
            var n = /@font-face[ ]?{[^}]*}/g,
                r = e.match(n);
            if (!r) throw new Se("No @font-face rules found in file from " + t);
            return r
        },
        Wr = function(e) {
        ...
        Kr = function(e, t) {
            var n = e.replace(/\/\*.*\*\//g, "").trim(),
                ...
                o = r.match(/((([^;(]*\([^()]*\)[^;)]*)|[^;]+)+)(?=;)/g);
            if (!o) throw new Se("Found @font-face rule containing no valid font-properties in file from " + t);
            return o
        },
        Vr = function(e, t) {
            var n = e.indexOf(":");
            if (-1 === n) throw new Se("Invalid css declaration in file from " + t + ': "' + e + '"');
            var r = e.slice(0, n).trim(),
                o = xt[r];
            if (!o) throw new Se("Unsupported css property in file from " + t + ': "' + r + '"');
            return {
                property: o,
        ...
        Jr = function(e, t) {
            ...
            return ["family", "src"].forEach(function(e) {
                if (!n[e]) throw new Se("Missing css property in file from " + t + ': "' + Dt[e] + '"')
            }), n
        },
        Qr = function(e) {
            return zr({
        ...
        co = _t({
            ...
            detail: nt(tt, function() {
                return ""
            })
        }),
        uo = $e.apply(void 0, F(Object.keys(ro))),
        lo = _t({
            origin: tt,
            name: tt
        }),
        po = _t({
            displayItems: Ke(lt(so)),
            shippingOptions: Ke(pt("id")(lt(co))),
            total: ao,
            requestShipping: Ke(rt),
            requestPayerName: Ke(rt),
            requestPayerEmail: Ke(rt),
            requestPayerPhone: Ke(rt),
            shippingType: Ke(uo),
            currency: et,
            country: Ze,
            jcbEnabled: Ke(rt),
            __billingDetailsEmailOverride: Ke(tt),
            __minApplePayVersion: Ke(ot),
            __merchantDetails: Ke(lo),
            __skipGooglePayInPaymentRequest: Ke(rt)
        }),
        fo = ht({
            currency: Ke(et),
            displayItems: Ke(lt(so)),
        ...
        ho = function(e, t) {
            ...
            return $e.apply(void 0, F(Object.keys(to)))(-1 !== n.indexOf(e) ? "fail" : e, t)
        },
        _o = _t({
            displayItems: Ke(lt(so)),
            shippingOptions: Ke(pt("id")(lt(co))),
        ...
        mo = $e.apply(void 0, F(Object.keys(oo))),
        yo = function(e) {
            var t = qr(e, Mr.google_pay_beta_1);
            return pr ? t ? ["APPLE_PAY", "GOOGLE_PAY"] : ["APPLE_PAY"] : t ? ["GOOGLE_PAY", "BROWSER"] : ["BROWSER"]
        },
        vo = yo,
        ...
        go = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
        } : function(e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        },
        Eo = function(e) {
            return e && "object" === (void 0 === e ? "undefined" : go(e)) && (e.constructor === Array || e.constructor === Object)
        },
        wo = function(e) {
            return Eo(e) ? Array.isArray(e) ? e.slice(0, e.length) : bo({}, e) : e
        },
        So = function e(t) {
            return function() {
                for (var n = arguments.length, r = Array(n), o = 0; o < n; o++) r[o] = arguments[o];
                if (Array.isArray(r[0]) && t) return wo(r[0]);
                var i = Array.isArray(r[0]) ? [] : {};
                return r.forEach(function(n) {
                    n && Object.keys(n).forEach(function(r) {
                        var o = i[r],
                            a = n[r],
                            s = Eo(o) && !(t && Array.isArray(o));
                        "object" === (void 0 === a ? "undefined" : go(a)) && s ? i[r] = e(t)(o, wo(a)) : void 0 !== a ? i[r] = Eo(a) ? e(t)(a) : wo(a) : void 0 !== o && (i[r] = o)
                    })
                }), i
            }
        },
        ...
        To = function(e, t, n, r) {
            var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : Po,
                i = Math.max(Po, o);
            if (window.ApplePaySession) {
                if (Oo()) {
                    if (n && "https:" !== window.location.protocol) return window.console && window.console.warn("To test Apple Pay, you must serve this page over HTTPS."), Te.resolve(!1);
                    if (window.ApplePaySession.supportsVersion(i)) {
                        var a = t ? [e, t] : [e],
                            s = "merchant." + a.join(".") + ".stripe";
                        return Ao(s).then(function(o) {
                    ...
                    return n && window.console && window.console.warn("This version of Safari does not support ApplePay JS version " + i + "."), Te.resolve(!1)
                }
                return Te.resolve(!1)
            }
            return Te.resolve(!1)
        ...
        Io = ["mastercard", "visa"],
        Ro = ["AT", "AU", "BE", "CA", "CH", "DE", "DK", "EE", "ES", "FI", "FR", "GB", "GR", "HK", "IE", "IT", "JP", "LT", "LU", "LV", "MX", "NL", "NO", "NZ", "PL", "PT", "SE", "SG", "US"],
        No = function(e, t) {
            var n = "US" === e || t ? ["discover", "diners", "jcb"].concat(Io) : Io;
            return -1 !== Ro.indexOf(e) ? ["amex"].concat(B(n)) : n
        },
        Co = function(e, t) {
        ...
        Bo = (be = {}, U(be, oo.success, 0), U(be, oo.fail, 1), U(be, oo.invalid_payer_name, 2), U(be, oo.invalid_shipping_address, 3), U(be, oo.invalid_payer_phone, 4), U(be, oo.invalid_payer_email, 4), be),
        Uo = (ge = {}, U(ge, ro.pickup, "storePickup"), U(ge, ro.shipping, "shipping"), U(ge, ro.delivery, "delivery"), ge),
        Ho = {
            total: function(e) {
                return Do(e.total, e)
            },
        ...
        zo = {
            shippingType: function(e) {
                ...
                throw new Se("Invalid value for shippingType: " + t)
            },
            ...
            countryCode: Fo("country"),
            currencyCode: Fo("currency"),
            ...
            supportedNetworks: function(e) {
                return Co(e.country, e.jcbEnabled || !1)
            }
        },
        Yo = {
            status: function(e) {
                return Bo[e.status] || 0
            }
        },
        Go = qo({}, Ho, zo),
        Wo = qo({}, Ho, Yo),
        ...
        ti = function(e, t) {
            var n = e.shippingContact,
                ...
                o = e.billingContact;
            return {
                shippingOption: r && t.shippingOptions && t.shippingOptions.length ? ei(r, t.shippingOptions) : null,
                shippingAddress: n ? Zo(n) : null,
                payerEmail: $o(n),
                payerPhone: Qo(n),
                payerName: Xo(o),
        ...
        si = function(e, t) {
            return e && "object" === (void 0 === e ? "undefined" : ii(e)) ? t(e) : null
        },
        ci = function() {
            function e(t) {
                var n = this;
                z(this, e), this._onEvent = function() {}, this.setEventHandler = function(e) {
                    ...
                    return To(window.location.hostname, n._authentication.accountId, xe(n._authentication.apiKey) === De.test, n._report, n._minimumVersion)
                }, this.update = function(e) {
                    n._initialPaymentRequest = ko(n._paymentRequestOptions, e), n._initializeSessionState()
                }, this.show = function() {
                    n._initializeSessionState();
                    var e = void 0;
                    try {
                        e = new window.ApplePaySession(n._minimumVersion, Ko(n._paymentRequestOptions))
                    } catch (e) {
                        throw "Must create a new ApplePaySession from a user gesture handler." === e.message ? new Se("show() must be called from a user gesture handler (such as a click handler, after the user clicks a button).") : e
                    }
                    ...
                    return function(t) {
                        var r = t.payment,
                            o = n._usesButtonElement() ? Rt.paymentRequestButton : null;
                        n._controller.action.tokenizeWithData({
                            type: "apple_pay",
                            elementName: o,
                            tokenData: ri({}, r, {
                                billingContact: si(r.billingContact, n._normalizeContact)
                            }),
                            mids: n._mids
                        }).then(function(t) {
                            if ("error" === t.type) e.completePayment(window.ApplePaySession.STATUS_FAILURE), n._report("error.pr.create_token_failed", {
                                ...
                                var o = si(r.shippingContact, n._normalizeContact),
                                    i = si(r.billingContact, n._normalizeContact);
                    ...
                    if (e.country && "string" == typeof e.country) {
                        var t = e.country.toLowerCase().replace(/[^a-z]+/g, ""),
                            r = void 0;
                        return e.countryCode ? "string" == typeof e.countryCode && (r = e.countryCode.toUpperCase()) : (r = ai[t]) || n._report("warn.pr.apple_pay.missing_country_code", {
                            country: e.country
                        }), ri({}, e, {
                            countryCode: r
                        })
                    ...
                    return function(t) {
                        n._paymentRequestOptions = ko(n._paymentRequestOptions, {
                            status: t
                        });
                        var r = Vo(n._paymentRequestOptions),
                            o = r.status;
                    ...
                    return function(t) {
                        n._onEvent({
                            ...
                            payload: {
                                shippingAddress: Zo(n._normalizeContact(t.shippingContact)),
                    ...
                    return function(t) {
                        n._paymentRequestOptions = ko(n._paymentRequestOptions, t), n._paymentRequestOptions.shippingOptions && n._paymentRequestOptions.shippingOptions.length && (n._privateShippingOption = n._paymentRequestOptions.shippingOptions[0]);
                        var r = Vo(n._paymentRequestOptions),
                            o = r.status,
                            i = r.shippingMethods,
                            a = r.total,
                    ...
                    return function(t) {
                        if (n._paymentRequestOptions.shippingOptions) {
                            var r = ei(t.shippingMethod, n._paymentRequestOptions.shippingOptions);
                    ...
                    return function(t) {
                        n._paymentRequestOptions = ko(n._paymentRequestOptions, t);
                        var r = Vo(n._paymentRequestOptions),
                            o = r.status,
                            i = r.total,
                            a = r.lineItems;
                ...
                this._controller = r, this._authentication = o, this._mids = i, this._minimumVersion = a.__minApplePayVersion || Po, this._usesButtonElement = s, this._initialPaymentRequest = a, this._isShowing = !1, this._initializeSessionState()
            }
            return oi(e, [{
                key: "_initializeSessionState",
                value: function() {
                    this._paymentRequestOptions = ri({}, io, this._initialPaymentRequest, {
                        status: oo.success
                ...
                value: function(e, t) {
                    var n = this;
                    e.addEventListener("validatemerchant", on(this._validateMerchant(e, t))), e.addEventListener("paymentauthorized", on(this._paymentAuthorized(e))), e.addEventListener("cancel", on(function() {
                        n._isShowing = !1, n._onEvent({
                            type: "cancel"
                        }), n._onEvent({
                            type: "close"
                        })
                    })), e.addEventListener("shippingcontactselected", on(this._shippingContactSelected(e))), e.addEventListener("shippingmethodselected", on(this._shippingMethodSelected(e)))
                }
            }]), e
        }(),
        ui = ci,
        li = null,
        pi = function(e) {
            return null !== li ? Te.resolve(li) : e().then(function(e) {
                return li = e
            })
        },
        di = pi,
        fi = function() {
            return "https:" === window.location.protocol && !(!fr && !hr)
        },
        hi = fi,
        ...
        mi = function e(t) {
            var n = this;
            Y(this, e), this._mids = null, this._frame = null, this._backdrop = new Dn({
                lockScrolling: !1,
                lockFocus: !0,
                lockFocusOn: null
            }), this._initFrame = function(e) {
                var t = n._controller.createHiddenFrame(kt.PAYMENT_REQUEST_GOOGLE_PAY, {
            ...
            }, this._controller = t.controller, this._authentication = t.authentication, this._mids = t.mids, this._usesButtonElement = t.usesButtonElement, hi() && this._controller && (this._controller.action.fetchLocale({
                locale: "auto"
        ...
        bi = null,
        gi = function(e, t) {
            return null !== bi ? Te.resolve(bi) : vi ? t && "https:" !== window.location.protocol ? (window.console && window.console.warn("To test Payment Request, you must serve this page over HTTPS."), Te.resolve(!1)) : e ? e.action.checkCanMakePayment().then(function(e) {
                var t = e.available;
                return bi = !0 === t
            }) : Te.resolve(!1) : Te.resolve(!1)
        },
        ...
        wi = function e(t) {
            G(this, e), Si.call(this);
            var n = t.authentication,
                r = t.controller,
                o = t.mids,
                i = t.usesButtonElement,
                a = t.options;
            if (this._authentication = n, this._controller = r, this._mids = o, this._usesButtonElement = i, vi && "https:" === window.location.protocol) {
                this._controller.action.fetchLocale({
                    locale: "auto"
                });
                var s = this._controller.createHiddenFrame(kt.PAYMENT_REQUEST_BROWSER, {
                    authentication: n,
                    mids: this._mids
                });
        ...
        Si = function() {
            ...
            this._onEvent = function() {}, this.setEventHandler = function(t) {
                ...
                return gi(e._prFrame, xe(e._authentication.apiKey) === De.test)
                ...
                if (!e._prFrame) throw new Se("Payment Request is not available in this browser.");
                e._prFrame.send({
                    action: "stripe-pr-show",
                    payload: {
                        data: {
        ...
        Pi = function(e) {
            function t(e) {
                ...
                Ai.call(n), n._controller = e.controller, n._authentication = e.authentication, n._mids = e.mids, n._report("pr.options", {
                    options: e.rawOptions
                });
                var r = yt(po, e.rawOptions || {}, "paymentRequest()"),
                    o = r.value;
                if (r.warnings.forEach(function(e) {
                        return n._warn(e)
                    }), o.__billingDetailsEmailOverride && o.requestPayerEmail) throw new Se("When providing `__billingDetailsEmailOverride`, `requestPayerEmail` has to be `false` so that the customer is not prompted for their email in the payment sheet.");
                return n._queryStrategy = e.queryStrategyOverride || vo(e.betas), n._report("pr.query_strategy", {
                    queryStrategy: n._queryStrategy
                }), n._initialOptions = Oi({}, o, {
        ...
        Ai = function() {
            ...
            this._usedByButtonElement = null, this._showCalledByButtonElement = !1, this._isShowing = !1, this._backingLibraries = {
                ...
                e._queryStrategy.forEach(function(n) {
                    ...
                    switch (n) {
                        case "APPLE_PAY":
                            e._backingLibraries.APPLE_PAY = new ui(r), e._backingLibraries.APPLE_PAY.setEventHandler(e._handleInternalEvent);
                            break;
                        case "GOOGLE_PAY":
                            e._backingLibraries.GOOGLE_PAY = new yi(r), e._backingLibraries.GOOGLE_PAY.setEventHandler(e._handleInternalEvent);
                            break;
                        case "BROWSER":
                            e._backingLibraries.BROWSER = new ki(r), e._backingLibraries.BROWSER.setEventHandler(e._handleInternalEvent);
                            break;
                        default:
                            ke(n)
                    }
                    ...
                    case "paymentmethod":
                        var c = t.type,
                            ...
                            f = function(t) {
                                ...
                                var n = yt(mo, t, "status for PaymentRequest completion"),
                                    r = n.value;
                ...
                var n = t.__googlePayBillingAddress,
                    ...
                    s = i.payerPhone,
                    c = i.complete,
                    u = e._showCalledByButtonElement ? Rt.paymentRequestButton : null;
                ...
                return Te.race([new Te(function(e) {
                    ...
                    return e._canMakePaymentAvailability = Oi({}, e._canMakePaymentAvailability, W({}, t, n)), {
            ...
            }, this.canMakePayment = on(function() {
                ...
                if ("https:" !== window.location.protocol) return e._canMakePaymentResolved = !0, Te.resolve(null);
            ...
            }), this.update = on(function(t) {
                if (e._isShowing) throw e._report("pr.update_called_while_showing"), new Se("You cannot update Payment Request options while the payment sheet is showing.");
                e._report("pr.update", {
                    updates: t
                });
                var n = yt(fo, t, "PaymentRequest update()"),
                    r = n.value;
                n.warnings.forEach(function(t) {
                    return e._warn(t)
                }), e._activeBackingLibrary && e._activeBackingLibrary.update(r)
            }), this.show = on(function() {
                if (e._usedByButtonElement && !e._showCalledByButtonElement && (e._report("pr.show_called_with_button"), e._warn("Do not call show() yourself if you are using the paymentRequestButton Element. The Element handles showing the payment sheet.")), !e._canMakePaymentResolved) throw e._report("pr.show_called_before_can_make_payment"), new Se("You must first check the Payment Request API's availability using paymentRequest.canMakePayment() before calling show().");
                if (!e._activeBackingLibrary) throw e._report("pr.show_called_with_can_make_payment_false"), new Se("Payment Request is not available in this browser.");
                var t = e._activeBackingLibrary;
                e._report("pr.show", {
                    listeners: Object.keys(e._callbacks).sort()
                }), e._isShowing = !0, t.show()
            }), this.abort = on(function() {
        ...
        Ri = {
            classes: Ke(_t({
                ...
                focus: Ke(tt),
                invalid: Ke(tt),
                webkitAutofill: Ke(tt)
            })),
            hidePostalCode: Ke(rt),
            hideIcon: Ke(rt),
            style: Ke(_t(Ii)),
            iconStyle: Ke($e("solid", "default")),
            value: Ke(Ve(tt, ut)),
            __privateCvcOptional: Ke(rt),
            __privateValue: Ke(Ve(tt, ut)),
            __privateEmitIbanValue: Ke(rt),
            error: Ke(_t({
                type: tt,
                code: Ke(tt),
                decline_code: Ke(tt),
            ...
            placeholder: Ke(tt),
            disabled: Ke(rt),
            placeholderCountry: Ke(tt),
            paymentRequest: Ke(function(e, t) {
                return function(n, r) {
                    return n instanceof e ? ze(n) : We("a " + t + " instance", n, r)
                }
            }(Ti, "stripe.paymentRequest(...)")),
            supportedCountries: Ke(lt(tt)),
            accountHolderType: Ke($e("individual", "company"))
        },
        Ni = _t(Ri),
        Ci = function(e, t, n) {
            var r = "auBankAccount" === e && !qr(n, "au_bank_account_beta_1") || "fpxBank" === e && !qr(n, "fpx_bank_beta_1");
            if (!e || !(e in mr) || r) throw new Se("A valid Element name must be provided. Valid Elements are:\n" + Object.keys(mr).filter(function(e) {
                return !mr[e].beta
            }).join(", ") + "; you passed: " + e + ".");
            if (mr[e].unique && -1 !== t.indexOf(e)) throw new Se("Can only create one Element of type " + e + ".");
            var o = mr[e].conflict,
                i = Ne(t, o);
            if (i.length) {
                var a = i[0];
                throw new Se("Cannot create an Element of type " + e + " after an Element of type " + a + " has already been created.")
            }
        },
        ji = "14px",
        Mi = function(e) {
        ...
        Li = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "1.2em",
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ji,
        ...
        Wi = function(e) {
            function t(e) {
                ...
                if (a) {
                    if (!i) throw new Se("You must pass in a stripe.paymentRequest object in order to use this Element.");
                    n._paymentRequest = i, n._paymentRequest._registerElement()
                }
                return n._createComponent(e, o), n._classes = Ui, n._changeClasses(e.classes || {}), n._lastBackgroundColor = "", n._destroyed = !1, n._focused = !1, n._empty = !a, n._invalid = !1, n._complete = !1, n._autofilled = !1, n._lastSubmittedAt = null, n
            }
            return te(t, e), Bi(t, [{
                key: "_checkDestroyed",
                value: function() {
                    if (this._destroyed) throw new Se("This Element has already been destroyed. Please create a new one.")
                }
            }, {
                key: "_isMounted",
                value: function() {
                ...
                value: function(e) {
                    ...
                    if (e === t) {
                        ...
                        if (n) throw new Se("This Element is already mounted. Use `unmount()` to unmount the Element before re-mounting.");
                        this.unmount(), this._mountTo(e)
                ...
                value: function(e) {
                    ...
                    return Object.keys(e).forEach(function(n) {
                        if (!Ui[n]) throw new Se(n + " is not a customizable class name.\nYou can customize: " + Object.keys(Ui).join(", "));
                        var r = e[n] || Ui[n];
                        t[n] = r.replace(/\./g, " ")
                    }), this._classes = Fi({}, this._classes, t), this
                }
            }, {
                key: "_emitEvent",
                value: function(e, t) {
                    return this._emit(e, Fi({
                ...
                value: function() {
                    ...
                    this._frame._on("redirectfocus", function(t) {
                        ...
                        var n = {};
                        ["error", "value", "empty", "complete"].concat(X(wr[e._componentName] || [])).forEach(function(e) {
                            return n[e] = t[e]
                        ...
                        if (e._parent) {
                            ...
                            if (n) {
                                ...
                                0 !== r && Yi(r) < Yi(o) && e._controller.report("wrapper_height_mismatch", {
                                    height: o,
                                    outer_height: r
                                });
                                var s = e._component.getBoundingClientRect().height;
                                0 !== s && 0 !== o && Yi(s) !== Yi(o) && (e._frame.updateStyle({
                                    height: o + "px"
                ...
                value: function(e, t, n) {
                    var r = this._controller.createSecondaryElementFrame(e, Fi({}, n, {
                        componentName: t
                    }));
                ...
                value: function(e) {
                    ...
                    if ("paymentRequestButton" === this._componentName) {
                        ...
                        if (l && !Gi(l) && this._controller.warn("The fontSize style you specified (" + l + ") is not in px. We do not recommend using relative css units, as they will be calculated relative to our iframe's styles rather than your site's."), t || u || l) {
                            var d = -1 === Ft.indexOf(this._componentName) ? void 0 : p || this._lastPadding,
                                f = qi(u || this._lastHeight, l || this._lastFontSize, d);
                ...
                value: function(e, t) {
                    var n = this,
                        r = (e.classes, e.controller, e.paymentRequest, $(e, ["classes", "controller", "paymentRequest"])),
                        o = document.createElement("div");
                    o.className = "__PrivateStripeElement";
                    var i = document.createElement("input");
                    i.className = "__PrivateStripeElement-input", i.setAttribute("aria-hidden", "true"), i.setAttribute("aria-label", " "), i.setAttribute("autocomplete", "false"), i.maxLength = 1, i.disabled = !0, Qt(o, Hi), Qt(i, zi);
                    var a = xi(document.body),
                    ...
                    if (l._on("load", function() {
                        ...
                        var p = Sr[t].secondary;
                        this._secondaryFrame = this._createSecondFrame(c, p, Fi({}, u, {
                            primaryElementType: t
                        })), this._secondaryFrame.appendTo(o), window.addEventListener("click", function() {
                            return n._handleOutsideClick()
                        })
                    }
                    if (o.appendChild(i), lr && t !== Rt.paymentRequestButton) {
                        var d = document.createElement("input");
                        d.className = "__PrivateStripeElement-safariInput", d.setAttribute("aria-hidden", "true"), d.setAttribute("tabindex", "-1"), d.setAttribute("autocomplete", "false"), d.maxLength = 1, d.disabled = !0, Qt(d, zi), o.appendChild(d)
                    }
        ...
        Ki = function() {
            var e = this;
            this._paymentRequest = null, this.mount = on(function(t) {
                e._checkDestroyed();
                var n = void 0;
                if (!t) throw new Se("Missing argument. Make sure to call mount() with a valid DOM element or selector.");
                if ("string" == typeof t) {
                    var r = document.querySelectorAll(t);
                    if (r.length > 1 && e._controller.warn("The selector you specified (" + t + ") applies to " + r.length + " DOM elements that are currently on the page.\nThe Stripe Element will be mounted to the first one."), !r.length) throw new Se("The selector you specified (" + t + ") applies to no DOM elements that are currently on the page.\nMake sure the element exists on the page before calling mount().");
                    n = r[0]
                } else {
                    if (!t.appendChild) throw new Se("Invalid DOM element. Make sure to call mount() with a valid DOM element or selector.");
                    n = t
                }
                if ("INPUT" === n.nodeName) throw new Se("Stripe Elements must be mounted in a DOM element that\ncan contain child nodes. `input` elements are not permitted to have child\nnodes. Try using a `div` element instead.");
                if (n.children.length && e._controller.warn("This Element will be mounted to a DOM element that contains child nodes."), e._paymentRequest) {
                    if (!e._paymentRequest._canMakePaymentResolved) throw new Se("For the paymentRequestButton Element, you must first check availability using paymentRequest.canMakePayment() before mounting the Element.");
                    if (!e._paymentRequest._activeBackingLibraryName) throw new Se("The paymentRequestButton Element is not available in the current environment.");
                    e._mountToParent(n)
                } else e._mountToParent(n)
            }), this.update = on(function(t) {
                e._checkDestroyed();
                var n = yt(Ni, t || {}, "element.update()"),
                    r = n.value;
        ...
        Qi = {
            locale: Ke(tt),
            fonts: Ke(lt(ut)),
            betas: Ke(lt(Xe.apply(void 0, re(Lr))))
        },
        $i = _t(Qi),
        Xi = function e(t, n) {
            var r = this;
            ne(this, e), Zi.call(this);
            var o = yt($i, n || {}, "elements()"),
                i = o.value;
            o.warnings.forEach(function(e) {
                return t.warn(e)
            }), jr(t.warn), t.report("elements", {
                options: n
            }), this._elements = [], this._id = Ut("elements"), this._controller = t;
            var a = i.locale,
                s = i.fonts || [];
            this._controller.action.fetchLocale({
                locale: a || "auto"
            ...
            var c = s.filter(function(e) {
                ...
                u = s.map(function(e) {
                    ...
                    return "string" == typeof t ? [].concat(re(e), [t]) : e
                }, []).map(function(e) {
                    return bt(e) ? e : wt(window.location.href, e)
                });
            return this._pendingFonts = u.length, this._commonOptions = Ji({}, i, {
                fonts: c
                ...
                if ("string" == typeof e) {
                    ...
                    $r(e).then(function(n) {
                        ...
                        r._controller.action.updateCSSFonts({
                            fonts: o,
                            groupId: r._id
                        }), r._commonOptions = Ji({}, r._commonOptions, {
                            fonts: [].concat(re(r._commonOptions.fonts ? r._commonOptions.fonts : []), re(o))
                        })
                    }).catch(function(n) {
        ...
        Zi = function() {
            var e = this;
            this.create = an(function(t, n) {
                Ci(t, e._elements, e._betas);
                var r = yt(Ni, n || {}, "create()"),
                    o = r.value;
                r.warnings.forEach(function(t) {
                    return e._controller.warn(t)
                });
                var i = Ji({}, o, e._commonOptions, {
                        componentName: t,
                        groupId: e._id
                    }),
                    a = (sr || cr) && Gt(i).length > 2e3,
                    s = !!e._pendingFonts || a,
                    c = new Vi(Ji({}, i, {
                ...
                return e._elements = [].concat(re(e._elements), [t]), c._on("destroy", function() {
        ...
        ca = function(e, t) {
            if ("string" != typeof e) return We("a client_secret string", e, t);
            var n = aa(e);
            return null === n ? We("a client secret of the form ${id}_secret_${secret}", e, t) : ze(n, [])
        },
        ua = function(e, t) {
            if (null == e) return ze(null);
            var n = e.type,
                r = ie(e, ["type"]),
                o = oa({}, t, {
        ...
        da = function(e, t) {
            ...
            if ("object" !== (void 0 === e ? "undefined" : ra(e))) return Ge("object", void 0 === e ? "undefined" : ra(e), t);
            ...
            if ("string" != typeof r) {
                ...
                return Ge("string", void 0 === r ? "undefined" : ra(r), s)
            }
            if (("requires_source_action" === r || "requires_action" === r) && "object" !== (void 0 === o ? "undefined" : ra(o))) {
                var c = oa({}, t, {
                    path: [].concat(oe(t.path), ["next_action"])
                });
                return Ge("object", void 0 === o ? "undefined" : ra(o), c)
            }
        ...
        fa = function(e) {
            return function(t, n) {
                if ("object" === (void 0 === t ? "undefined" : ra(t)) && null !== t) {
                    var r = t.source,
                        o = t.source_data,
                        i = t.payment_method,
                    ...
                    if (null != r && "string" != typeof r) {
                        ...
                        return Ge("string", void 0 === r ? "undefined" : ra(r), c)
                    }
                    if (null != i && "string" != typeof i) {
                        var u = oa({}, n, {
                            path: [].concat(oe(n.path), ["payment_method"])
                        });
                        return Ge("string", void 0 === i ? "undefined" : ra(i), u)
                    }
                    if (null != o && "object" !== (void 0 === o ? "undefined" : ra(o))) {
                        var l = oa({}, n, {
                            path: [].concat(oe(n.path), ["source_data"])
                        });
                        return Ge("object", void 0 === o ? "undefined" : ra(o), l)
                    }
                    if (null != a && "object" !== (void 0 === a ? "undefined" : ra(a))) {
                        var p = oa({}, n, {
                            path: [].concat(oe(n.path), ["payment_method_data"])
                        });
                        return Ge("object", void 0 === a ? "undefined" : ra(a), p)
                    }
                    var d = oa({}, n, {
                            path: [].concat(oe(n.path), ["source_data"])
                        }),
                ...
                return null === t ? Ge("object", "null", n) : Ge("object", void 0 === t ? "undefined" : ra(t), n)
            }
        },
        ha = function(e) {
            return function(t, n) {
                if (void 0 === t) return ze({
                    sourceData: null,
                ...
                if ("object" !== (void 0 === t ? "undefined" : ra(t))) return Ge("object", void 0 === t ? "undefined" : ra(t), n);
                if (null === t) return Ge("object", "null", n);
                if (e) {
                    if (!t.payment_intent) return ze({
                        sourceData: null,
                        paymentMethodData: null,
                        source: null,
                        paymentMethod: null,
                ...
                return t.payment_intent ? Ye(new Se("The payment_intent parameter has been removed. To fix, move everything nested under the payment_intent parameter to the top-level object.")) : fa({})(t, n)
            }
        },
        _a = {
        ...
        ma = (Ee = {}, ae(Ee, Rt.card, _a.card), ae(Ee, Rt.cardNumber, _a.card), ae(Ee, Rt.cardExpiry, _a.card), ae(Ee, Rt.cardCvc, _a.card), ae(Ee, Rt.postalCode, _a.card), ae(Ee, Rt.iban, _a.sepa_debit), ae(Ee, Rt.idealBank, _a.ideal), Ee),
        ya = function(e) {
            return -1 === Mt.indexOf(e)
        },
        va = function(e, t) {
            return null != t ? t : ya(e) ? null : ma[e] || null
        },
        ba = function(e) {
            var t = e.name,
                n = e.value,
        ...
        wa = "__privateStripeMetricsController",
        Sa = {
            MERCHANT: "merchant",
            SESSION: "session"
        },
        ka = function() {
            function e() {
                ...
                } else this._muid = this._getID(Sa.MERCHANT), this._sid = this._getID(Sa.SESSION), this._doNotPersist = !1;
                this._id = Ut(wa), this._controllerFrame = new wn(kt.METRICS_CONTROLLER, this._id, {
                    autoload: !0,
                    queryString: this._buildFrameQueryString()
                }), this._guidPromise = new Te(function(e) {
            ...
            return Ea(e, [{
                ...
                value: function() {
                    ...
                    setInterval(function() {
                        ...
                        n !== t && (e.send({
                            action: "ping",
                            payload: {
                                sid: e._getID(Sa.SESSION),
                                muid: e._getID(Sa.MERCHANT),
                ...
                value: function(e, t) {
                    try {
                        this.send({
                            action: "track",
                            payload: {
                                sid: this._getID(Sa.SESSION),
                                muid: this._getID(Sa.MERCHANT),
                                url: document.location.href,
                                source: e,
                                data: t
                            }
                ...
                key: "send",
                value: function(e) {
                    var t = Tt(kt.METRICS_CONTROLLER);
                    Qn(t) && this._controllerFrame.send(e)
                }
            }, {
                key: "_testLatency",
                value: function() {
        ...
        Ra = function(e, t, n, r) {
            if (null === e) {
                if (null === t) {
                    throw new Se(n + ": you must additionally specify the type of payment method to create within " + (r ? "source_data" : "payment_method_data") + ".")
                }
                return t
            }
            if (null === t) return e;
            if (t !== e) throw new Se(n + ": you specified `type: " + t + "`, but " + n + " will create a " + e + " payment method.");
            return e
        },
        Na = function(e, t, n, r, o, i) {
            var a = mt(Aa, o, r);
            ...
            var s = a.value,
                ...
                f = u.paymentMethod,
                h = u.otherParams;
            if (!e && l) throw new Se(r + ": Expected payment_method_data, not source_data.");
            if (null != p) throw new Se("When calling " + r + " on an Element, you can't pass in a pre-existing source ID, as a source will be created using the Element.");
            if (null != f) throw new Se("When calling " + r + " on an Element, you can't pass in a pre-existing PaymentMethod ID, as a PaymentMethod will be created using the Element.");
        ...
        Ca = function(e, t, n, r, o, i) {
            var a = yt(ha(t), o, r),
                ...
                p = s.paymentMethod,
                d = s.otherParams;
            if (!e && c) throw new Se(r + ": Expected payment_method, source, or payment_method_data, not source_data.");
            if (null !== u && null !== c) throw new Se(r + ": Expected either source or source_data, but not both.");
            if (null !== p && null !== l) throw new Se(r + ": Expected either payment_method or payment_method_data, but not both.");
            if (null !== p && null !== u) throw new Se(r + ": Expected either payment_method or source, but not both.");
            if (c || l) {
                var f = c || l || {},
                    h = f.type,
                    _ = f.data,
        ...
        ja = function(e, t, n, r) {
            return function(o, i) {
                var a = Na(e, t, n, r, o, i);
                if (a) return a;
                var s = Ca(e, t, n, r, o);
                if (s) return s;
                throw new Se("Expected: stripe." + r + "(intentSecret, element[, data]) or stripe." + r + "(intentSecret[, data]). Please see the docs for more usage examples https://stripe.com/docs/payments/dynamic-authentication")
            }
        },
        Ma = function(e, t) {
            var n = {
        ...
        qa = function(e, t, n) {
            ...
            if ("use_stripe_sdk" === e.type) {
                ...
                switch (r.type) {
                    case "cardinal_3ds2_fingerprint":
                        return {
                            type: "cardinal-sdk-fingerprint", bin: r.stripe_js.bin, jwt: r.stripe_js.jwt, env: r.stripe_js.env
                        };
                    case "stripe_3ds2_fingerprint":
                        return {
                            type: "3ds2-fingerprint", threeDS2Source: r.three_d_secure_2_source, cardBrand: La(r.directory_server_name), transactionId: r.server_transaction_id, optimizations: Ma(r.three_ds_optimizations, n), methodUrl: r.three_ds_method_url
                        };
                    case "stripe_3ds2_challenge":
                        return {
                            type: "3ds2-challenge", threeDS2Source: r.stripe_js.three_d_secure_2_source, cardBrand: La(r.stripe_js.directory_server_name), transactionId: r.stripe_js.server_transaction_id, optimizations: Ma(r.stripe_js.three_ds_optimizations, n), acsTransactionId: r.stripe_js.acs_transaction_id, acsUrl: r.stripe_js.acs_url
                        };
                    case "three_d_secure_redirect":
                        return {
                            type: "3ds1-modal", url: r.stripe_js
                        }
                }
            }
            if ("redirect_to_url" === e.type) {
                ...
                switch (t) {
                    case _a.ideal:
                        return {
                            type: "ideal-redirect", redirectUrl: o
                        }
                }
            }
            if ("authorize_with_url" === e.type) {
                ...
                switch (t) {
                    case _a.card:
                        return {
                            type: "3ds1-modal", url: i
                        };
                    case _a.ideal:
                        return {
                            type: "ideal-redirect", redirectUrl: i
                        }
                }
            }
            return null
        ...
        xa = function(e, t, n, r) {
            return t === Ct.PAYMENT_INTENT ? n.action.retrievePaymentIntent({
                hosted: !1,
                intentSecret: e,
                locale: r,
                asErrorIfNotSucceeded: !0
            }).then(Da) : n.action.retrieveSetupIntent({
                hosted: !1,
                intentSecret: e,
                locale: r,
                asErrorIfNotSucceeded: !0
        ...
        Ba = function(e, t, n) {
            return e.createLightboxFrame(kt.AUTHORIZE_WITH_URL, {
                url: t,
                locale: n
            })
        },
        Ua = function(e, t, n, r, o) {
            var i = Cr(),
                a = Date.now(),
                s = Ba(r, e, o);
            s.show(), r.report("authorize_with_url.loading", {
                viewport: i
            }), s._on("load", function() {
            ...
            var c = function(e) {
                return !(!e.code || !e.type) && !(!e.payment_intent && !e.setup_intent)
            };
            return s._on("challenge_complete", function() {
                s.fadeOutBackdrop()
            }), new Te(function(e, i) {
                s._once("authorize_with_url_done", function(i) {
                    r.report("authorize_with_url.done", {
                        shownDuration: Date.now() - a,
                        success: !("error" in i)
                    });
                    var u = function() {
                        return Te.all([xa(t, n, r, o), s.destroy()]).then(function(e) {
                            return Fa(e, 1)[0]
                        })
                    };
                    "fallback" === i.type ? u().then(e) : i.result.error && !c(i.result.error) ? u().then(e) : s.destroy().then(function() {
                        return e(i.result)
                    })
                })
            })
        ...
        Ga = function(e, t, n) {
            var r = e.createHiddenFrame(kt.STRIPE_3DS2_FINGERPRINT, {
                intentId: t,
                hosted: n
            });
        ...
        Wa = function(e, t, n, r) {
            var o = t.createLightboxFrame(kt.STRIPE_3DS2_CHALLENGE, {
                intentId: e,
                hosted: r
            });
            ...
            }), r && (o.show(), o.action.show3DS2Spinner({
                cardBrand: n
            })), i
        },
        Ka = function(e, t, n, r) {
            return t.optimizations.skipFingerprint ? Te.resolve({
        ...
        Va = function(e, t, n, r, o, i) {
            var a = Date.now(),
                s = Wa(e.id, r, n.cardBrand, i),
                c = function(n) {
                    return s.then(function(a) {
                        return new Te(function(s) {
                            var c = !0;
                            ! function n() {
                                xa(e, t, r, o).then(function(e) {
                                    if (c) {
                                        if (e.error) {
                                            var t = e.error,
                                                r = t.payment_intent || t.setup_intent;
                                            (r && "requires_payment_method" === r.status || r && "requires_source" === r.status) && s(e)
                                        }
                                        setTimeout(n, 5e3)
                                    }
                                })
                            ...
                            var u = (n.type, n.optimizations),
                                l = ce(n, ["type", "optimizations"]);
                            return a.action.perform3DS2Challenge(za({}, l, {
                                shouldSandbox: u.sandboxChallengeFrame
                            })).then(function() {
                                c = !1, s()
                            })
                        })
                ...
                l = function(n) {
                    return Te.all([n ? Te.resolve(n) : xa(e, t, r, o), s.then(function(e) {
                        return e.destroy()
                    })]).then(function(t) {
                        var n = Ha(t, 1),
                            o = n[0];
                        return r.report("3ds2.done", za({
                            intentId: e.id,
                            hosted: i,
            ...
            switch (n.type) {
                ...
                case "3ds2-fingerprint":
                    return Ka(e, n, r, i).then(u).then(function(t) {
                        if ("error" === t.type) return l();
                        var o = t.object.ares;
                        return "C" !== o.transStatus ? (r.report("3ds2.frictionless", {
                            hosted: i,
                            intentId: e.id
                        }), l()) : c({
                            type: "3ds2-challenge",
        ...
        $a = function(e, t, n) {
            return Ja(t).then(function(t) {
                return Qa(n, "ideal redirect", t), ia(t, e)
            })
        },
        Xa = function(e, t, n) {
            return e.createLightboxFrame(kt.CARDINAL_3DS2, {
                intentSecret: t,
                locale: n
            })
        },
        Za = function(e, t, n, r) {
            var o = Date.now(),
                i = Xa(n, e, r);
            return i.show(), n.report("cardinal_3ds2.frame.loading"), new Te(function(e) {
                i._on("load", function() {
                    n.report("cardinal_3ds2.frame.loaded", {
                        loadDuration: Date.now() - o
                    }), i.fadeInBackdrop(), i.action.performCardinal3DS2(t).then(function(t) {
        ...
        es = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
        } : function(e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        },
        ts = function(e) {
            if (!e || "object" !== (void 0 === e ? "undefined" : es(e))) return null;
            var t = e.type,
                n = ue(e, ["type"]);
            return {
        ...
        rs = {
            source: _t({
                id: Qe("src_"),
                client_secret: Qe("src_client_secret_")
            })
        },
        os = _t(rs),
        is = function(e) {
        ...
        cs = function(e) {
            switch (e.type) {
                case "error":
                    var t = e.error;
                    if ("payment_intent_unexpected_state" === t.code && "object" === ss(t.payment_intent) && null != t.payment_intent && "string" == typeof t.payment_intent.status && la(t.payment_intent.status)) {
        ...
        us = function(e, t, n, r, o) {
            var i = qa(pa(t), n, e),
                a = sa(t);
            if (!i) return Te.resolve({
                paymentIntent: t
            });
            switch (i.type) {
                case "3ds1-modal":
                    return Ua(i.url, a, Ct.PAYMENT_INTENT, e, r);
                case "3ds2-fingerprint":
                case "3ds2-challenge":
                    return Va(a, Ct.PAYMENT_INTENT, i, e, r, o);
                case "cardinal-sdk-fingerprint":
                    return Za(t.client_secret, {
                        jwt: i.jwt,
                        bin: i.bin,
                        env: i.env
                    }, e, r);
                case "ideal-redirect":
                    return $a(t, i.redirectUrl, e);
                default:
                    return Te.resolve({
                        paymentIntent: t
                    })
        ...
        ls = function(e, t, n, r, o) {
            return us(e, t, n, r, o).then(function(e) {
            ...
            return function(o) {
                ...
                switch (i.type) {
                    case "error":
                        var a = i.error,
                            s = a.payment_intent;
                        return n && s && "payment_intent_unexpected_state" === a.code && ("succeeded" === s.status || "requires_capture" === s.status) ? Te.resolve({
                            paymentIntent: s
                        }) : Te.resolve(ia(o));
                    case "object":
                        var c = i.object;
                        return ls(e, c, t, i.locale, r);
                    default:
                        return ke(i)
                }
            }
        ...
        ds = function(e, t, n, r, o) {
            var i = Ta(r);
            if ("string" != typeof n) return Te.reject(new Se("Please provide a PaymentMethod type to createPaymentMethod."));
            var a = ts(i ? o : r),
                s = a || {
                    type: null,
                    data: {}
                ...
                c = s.type,
                u = s.data;
            if (c && n !== c) return Te.reject(new Se("The type supplied in payment_method_data is not consistent."));
            if (i) {
                var l = i._frame.id,
                    p = i._componentName;
            ...
            return a ? e.action.createPaymentMethodWithData({
                ...
                paymentMethodData: u,
                mids: t
            }).then(is) : Te.reject(new Se("Please provide either an Element or PaymentMethod creation parameters to createPaymentMethod."))
        },
        fs = function(e, t) {
            var n = yt(ca, e, "retrievePaymentIntent"),
                r = n.value;
        ...
        hs = function(e, t, n, r, o, i) {
            var a = yt(ca, r, "stripe.confirmPaymentIntent intent secret"),
                s = a.value,
                c = ja(e, !1, null, "confirmPaymentIntent")(o, i);
            return t.action.confirmPaymentIntent(as({}, c, {
                intentSecret: s,
                expectedType: null,
                mids: n
            })).then(ia)
        ...
        _s = function(e, t) {
            var n = yt(ca, e, "[internal] stripe.handleHosted3DS2Setup intent secret"),
                r = n.value;
            return t.action.retrievePaymentIntent({
                intentSecret: r,
                hosted: !0
            }).then(ps(t, _a.card, !1, !0))
        },
        ms = function(e, t) {
            var n = yt(ca, e, "stripe.handleCardAction intent secret"),
                r = n.value;
            return t.action.retrievePaymentIntent({
                intentSecret: r,
                hosted: !1
                ...
                switch (n.type) {
                    case "error":
                        return Te.resolve(ia(e));
                    case "object":
                        var r = n.object;
                        if (la(r.status)) {
                            if ("manual" !== r.confirmation_method) throw new Se("handleCardAction: The PaymentIntent supplied does not require manual server-side confirmation. Please use handleCardPayment instead to complete the payment.");
                            return ls(t, r, _a.card, n.locale, !1)
                        }
                        throw new Se("handleCardAction: The PaymentIntent supplied is not in the requires_action state.");
                    default:
                        return ke(n)
                }
            })
        },
        ys = function(e, t, n, r, o, i, a) {
            var s = yt(ca, o, "stripe.handleCardPayment intent secret"),
                c = s.value,
                u = _a.card,
                l = ja(e, r, u, "handleCardPayment")(i, a),
                p = !i && !a;
            return t.action.confirmPaymentIntent(as({}, l, {
                otherParams: as({}, l.otherParams, {
                    use_stripe_sdk: !0
                }),
                intentSecret: c,
                expectedType: u,
        ...
        vs = function(e, t, n, r, o, i) {
            var a = yt(ca, r, "stripe.handleSepaDebitPayment intent secret"),
                s = a.value,
                c = _a.sepa_debit,
                u = ja(!1, n, c, "handleSepaDebitPayment")(o, i),
                l = !o && !i;
            return e.action.confirmPaymentIntent(as({}, u, {
                intentSecret: s,
                expectedType: c,
                mids: t
            })).then(ps(e, c, l))
        },
        bs = function(e, t, n, r, o, i, a) {
            var s = yt(ca, o, "stripe.handleIdealPayment intent secret"),
                c = s.value,
                u = _a.ideal,
                l = ja(e, r, u, "handleIdealPayment")(i, a),
                p = !i && !a;
            return t.action.confirmPaymentIntent(as({}, l, {
                intentSecret: c,
                expectedType: u,
        ...
        gs = function(e, t, n, r, o, i) {
            var a = yt(ca, r, "stripe.handleFpxPayment intent secret"),
                s = a.value,
                c = _a.fpx,
                u = ja(!1, n, c, "handleFpxPayment")(o, i),
                l = !o && !i;
            return e.action.confirmPaymentIntent(as({}, u, {
                intentSecret: s,
                expectedType: c,
        ...
        ws = function(e, t, n, r, o) {
            ...
            switch (i.type) {
                case "3ds1-modal":
                    return Ua(i.url, a, Ct.SETUP_INTENT, e, r);
                case "3ds2-fingerprint":
                case "3ds2-challenge":
                    return Va(a, Ct.SETUP_INTENT, i, e, r, o);
                default:
                    return Te.resolve({
                        setupIntent: t
                    })
        ...
        Ss = function(e, t, n, r, o) {
            return ws(e, t, n, r, o).then(function(e) {
            ...
            return function(o) {
                switch (o.type) {
                    case "error":
                        var i = o.error,
                            a = i.setup_intent;
                        return n && a && "succeeded" === a.status ? Te.resolve({
                            setupIntent: a
                        }) : Te.resolve({
                            error: i
                        });
        ...
        Ps = function(e, t, n, r, o) {
            var i = yt(ca, n, "stripe.handleCardSetup intent secret"),
                a = i.value,
                s = _a.card,
                c = ja(!1, !1, s, "handleCardSetup")(r, o),
                u = !r && !o;
        ...
        As = function(e, t, n, r, o) {
            var i = yt(ca, n, "stripe.handleSepaDebitSetup intent secret"),
                a = i.value,
                s = _a.sepa_debit,
                c = ja(!1, !1, s, "handleSepaDebitSetup")(r, o),
                u = !r && !o;
            return e.action.confirmSetupIntent(Es({}, c, {
                intentSecret: a,
                expectedType: s,
        ...
        Ts = function(e, t) {
            var n = yt(ca, e, "stripe.retrieveSetupIntent intent secret"),
                r = n.value;
        ...
        Is = function(e, t, n, r, o) {
            var i = yt(ca, n, "stripe.confirmSetupIntent intent secret"),
                a = i.value,
                s = ja(!1, !1, null, "confirmSetupIntent")(r, o);
            return e.action.confirmSetupIntent(Es({}, s, {
                otherParams: Es({}, s.otherParams),
                intentSecret: a,
                expectedType: null,
                mids: t
            })).then(ks)
        ...
        Rs = function(e, t) {
            var n = yt(ca, e, "stripe.handleCardSetup intent secret"),
                r = n.value;
            return t.action.retrieveSetupIntent({
                intentSecret: r,
                hosted: !0
            }).then(Os(t, _a.card, !1, !0))
        },
        Ns = [Mr.checkout_beta_2, Mr.checkout_beta_3, Mr.checkout_beta_4],
        Cs = [Mr.checkout_beta_2, Mr.checkout_beta_3, Mr.checkout_beta_4, Mr.checkout_pm_types],
        js = {
            da: "da",
            de: "de",
            en: "en",
        ...
        qs = {
            sku: Ke(tt),
            plan: Ke(tt),
            clientReferenceId: Ke(tt),
            locale: Ke($e.apply(void 0, ["auto"].concat(pe(Ms)))),
            customerEmail: Ke(tt),
            billingAddressCollection: Ke($e("required", "auto")),
            submitType: Ke($e("auto", "pay", "book", "donate")),
            paymentMethodTypes: Ke(lt($e("card", "ideal"))),
            allowIncompleteSubscriptions: Ke(rt)
        },
        Ds = function(e, t, n) {
            if (e && t || (e || t) && n) throw new Se("stripe.redirectToCheckout: Expected only one of sku, plan, or items.");
            ...
            throw new Se("stripe.redirectToCheckout: You must provide either sku, plan, or items.")
        },
        xs = function(e) {
            var t = ht(Ls({}, qs, {
                    items: Ke(Ve(lt(ht({
                ...
                n = yt(t, e, "stripe.redirectToCheckout"),
                r = n.value,
                o = r.sku,
                i = r.plan,
                a = r.items,
                s = le(r, ["sku", "plan", "items"]),
                c = Ds(o, i, a);
            return Ls({
                tag: "no-session",
                items: c
        ...
        Fs = function(e, t) {
            var n = ht(Ls({}, qs, {
                ...
                r = yt(n, e, "stripe.redirectToCheckout"),
                o = r.value;
            if (o.sessionId) {
                var i = o.sessionId;
                if (Object.keys(o).length > 1) throw new Se("stripe.redirectToCheckout: Do not provide other parameters when providing sessionId. Specify all parameters on your server when creating the CheckoutSession.");
                if (!/^cs_/.test(i)) throw new Se("stripe.redirectToCheckout: Invalid value for sessionId. You specified '" + i + "'.");
                if ("livemode" === t && /^cs_test_/.test(i)) throw new Se("stripe.redirectToCheckout: the provided sessionId is for a test mode Checkout Session, whereas Stripe.js was initialized with a live mode publishable key.");
                if ("testmode" === t && /^cs_live_/.test(i)) throw new Se("stripe.redirectToCheckout: the provided sessionId is for a live mode Checkout Session, whereas Stripe.js was initialized with a test mode publishable key.");
                return {
                    tag: "session",
                    sessionId: i
                }
            ...
            var a = (o.sessionId, o.sku, o.plan, o.items),
                s = o.successUrl,
                c = o.cancelUrl,
                u = le(o, ["sessionId", "sku", "plan", "items", "successUrl", "cancelUrl"]);
            if (!a) throw new Se("stripe.redirectToCheckout: You must provide one of items or sessionId.");
            if (!s || !c) throw new Se("stripe.redirectToCheckout: You must provide successUrl and cancelUrl.");
            return Ls({
                tag: "no-session",
                items: a,
                successUrl: s,
        ...
        Bs = function(e, t) {
            ...
            if ("no-session" === n.tag) {
                var r = n.successUrl,
                    o = n.cancelUrl;
                if (!bt(r)) throw new Se("stripe.redirectToCheckout: successUrl must start with either http:// or https://.");
                if (!bt(o)) throw new Se("stripe.redirectToCheckout: cancelUrl must start with either http:// or https://.");
                return n
            }
            return n
        },
        Us = function(e, t, n) {
            if (n && n.paymentMethodTypes) {
                if (-1 === t.indexOf("checkout_pm_types")) throw new Se("Invalid stripe.redirectToCheckout parameter: paymentMethodTypes is not an accepted parameter.");
                if (e) throw new Se("Invalid stripe.redirectToCheckout parameter: paymentMethodTypes is not an accepted parameter for " + e + ". Please follow our migration guide to update to the final version of Checkout: https://stripe.com/docs/payments/checkout/migration-from-beta")
            }
        },
        Hs = function(e, t) {
            return "session" === t.tag || null == e || t.locale || -1 === ["auto"].concat(pe(Ms)).indexOf(e) ? t : Ls({}, t, {
                locale: e
            })
        },
        zs = function(e, t, n) {
            var r = Ie(Ns, function(t) {
                return qr(e, t)
            });
            switch (Us(r, e, t), r) {
        ...
        Ks = function(e, t) {
            var n = function(t) {
                return Qa(e, "redirectToCheckout", t), {
                    error: t.error
                }
            };
            return Ja(t).then(n)
        ...
        Vs = function(e, t, n, r) {
            return function(o) {
                ...
                var c = i,
                    ...
                    y = c.allowIncompleteSubscriptions,
                    v = de(c, ["tag", "items", "successUrl", "cancelUrl", "clientReferenceId", "customerEmail", "billingAddressCollection", "submitType", "paymentMethodTypes", "allowIncompleteSubscriptions"]),
                    b = u.map(function(e) {
                        if (e.sku) return {
                            type: "sku",
                            id: e.sku,
                ...
                return e.action.createPaymentPage(Ws({
                    betas: t,
                    mids: n(),
                    items: b,
                    success_url: l,
        ...
        $s = function(e) {
            return "object" === (void 0 === e ? "undefined" : Js(e)) && null !== e ? e : {}
        },
        Xs = function(e, t, n) {
            var r = Ta(t);
            ...
            throw new Se("You must provide a `cardCvc` Element to create a `cvc_update` token.")
        },
        Zs = function(e, t) {
            return function(n, r) {
                var o = Ta(n);
                ...
                throw new Se("You must provide a Stripe Element or a valid token type to create a Token.")
            }
        },
        ec = function(e) {
            switch (e.type) {
        ...
        oc = _t({
            ...
            __hosted3DS: Ke(rt),
            canCreateRadarSession: Ke(rt),
            betas: Ke(lt(Xe.apply(void 0, he(Lr))))
        }),
        ic = function(e) {
        ...
        ac = function() {
            function e(t, n) {
                var r = this;
                fe(this, e), sc.call(this);
                var o = yt(oc, t || {}, "Stripe()"),
                    i = o.value,
                    a = o.warnings,
                    s = i.apiKey,
                    c = i.stripeAccount,
                    ...
                    h = i.betas;
                if ("" === s) throw new Se("Please call Stripe() with your publishable key. You used an empty string.");
                if (0 === s.indexOf("sk_")) throw new Se("You should not use your secret key with Stripe.js.\n        Please pass a publishable key instead.");
                p && p.mids && (e._ec = new Oa({
                    checkoutIds: p.mids
                })), this._apiKey = s, this._keyMode = xe(s), this._locale = u || null, this._betas = h || [], this._stripeAccount = c || null, this._isCheckout = !!p, this._controller = new Nr(nc({
                    apiKey: s,
                    __privateApiUrl: l,
                    stripeAccount: c,
                    betas: this._betas,
                ...
                }), this._ensureHTTPS(), this._ensureStripeHosted(n), this._attachPaymentIntentMethods(this._betas, !!d), this._attachCheckoutMethods(this._betas), this._attachPrivateMethodsForCheckout(this._isCheckout), this._attachCreateRadarSession(f || !1), this._warnIE9Deprecation()
            }
            return rc(e, [{
                key: "_attachCreateRadarSession",
                value: function(e) {
                    var t = this;
                    e && (this.createRadarSession = rn(function() {
                        var e = t._mids();
                        return tc(t._controller, e)
                    }))
                }
            }, {
                ...
                value: function(e, t) {
                    var n = this,
                        r = qr(this._betas, Mr.payment_intent_beta_1) || qr(this._betas, Mr.payment_intent_beta_2),
                        o = function() {
                            return n._mids()
                        },
                        i = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return ds.apply(void 0, [n._controller, o()].concat(t))
                        }),
                        a = on(function(e) {
                        ...
                        s = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return hs.apply(void 0, [!0, n._controller, o()].concat(t))
                        }),
                        c = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return hs.apply(void 0, [!1, n._controller, o()].concat(t))
                        }),
                        u = Tn(ys, ic("handleCardPayment")),
                        l = sn(function() {
                        ...
                        d = Tn(ms, ic("handleCardAction")),
                        f = on(function(e) {
                            return d(e, n._controller)
                        }),
                        h = Tn(Ps, ic("handleCardSetup")),
                        _ = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return h.apply(void 0, [n._controller, o()].concat(t))
                        }),
                        m = on(function(e) {
                            return Ts(e, n._controller)
                        }),
                        y = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return Is.apply(void 0, [n._controller, o()].concat(t))
                        }),
                        v = sn(function() {
                            for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
                            return vs.apply(void 0, [n._controller, o(), r].concat(t))
                        }),
                        b = sn(function() {
                            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return As.apply(void 0, [n._controller, o()].concat(t))
                        }),
                        g = sn(function() {
                            for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
                            return bs.apply(void 0, [!0, n._controller, o(), r].concat(t))
                        }),
                        E = sn(function() {
                            for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
                            return bs.apply(void 0, [!1, n._controller, o(), r].concat(t))
                        }),
                        w = sn(function() {
                            for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
                            return gs.apply(void 0, [n._controller, o(), r].concat(t))
                        }),
                        S = on(function(e) {
                            return _s(e, n._controller)
                        }),
                        k = on(function(e) {
                            return Rs(e, n._controller)
                        });
                    this.createPaymentMethod = i, this.retrievePaymentIntent = a, this.handleCardPayment = p, this.confirmPaymentIntent = c, this.handleCardAction = f, this.handleFpxPayment = w, this.handleCardSetup = _, this.retrieveSetupIntent = m, this.confirmSetupIntent = y;
                    var O = function(e) {
                        return function() {
                            throw new Se("You cannot call `stripe." + e + "` without supplying a PaymentIntents beta flag when initializing Stripe.js.        You can find more information including code snippets at https://www.stripe.com/docs/payments/payment-intents/quickstart.")
                        }
                    };
                    this.fulfillPaymentIntent = O("fulfillPaymentIntent"), this.handleSepaDebitPayment = O("handleSepaDebitPayment"), this.handleIdealPayment = O("handleIdealPayment"), qr(this._betas, Mr.payment_intent_beta_1) ? this.fulfillPaymentIntent = l : (qr(this._betas, Mr.payment_intent_beta_3) || qr(this._betas, Mr.payment_intent_beta_2)) && (this.handleCardPayment = l), qr(this._betas, Mr.payment_intent_beta_3) && (this.confirmPaymentIntent = s, this.handleIdealPayment = g, this.handleSepaDebitPayment = v), qr(this._betas, Mr.ideal_pm_beta_1) && (this.handleIdealPayment = E), qr(this._betas, Mr.sepa_pm_beta_1) && (this.handleSepaDebitPayment = v, this.handleSepaDebitSetup = b), t && (this.handleHosted3DS2Payment = S, this.handleHosted3DS2Setup = k)
                }
            }, {
                key: "_attachPrivateMethodsForCheckout",
                value: function(e) {
                    var t = this;
                    e && (this.tryNextAction = an(function(e, n) {
                        var r = yt(da, e, "Payment Intent"),
                            o = r.value,
                            i = Object.keys(_a).map(function(e) {
                                return _a[e]
                            }),
                            a = yt($e.apply(void 0, he(i)), n, "Source type"),
                            s = a.value;
                        return "payment_intent" === o.object ? ls(t._controller, o, s, "auto", !1) : Ss(t._controller, o, s, "auto", !1)
                    }))
                }
            }, {
                ...
                value: function(e) {
                    var t = this,
                        ...
                        r = e.reduce(function(e, t) {
                            var n = Ie(Cs, function(e) {
                                return e === t
                            });
                            return n ? [].concat(he(e), [n]) : e
                        }, []);
                    this.redirectToCheckout = Vs(this._controller, r, n, this._locale)
                }
            }, {
                key: "_warnIE9Deprecation",
                value: function() {
                    var e = this._keyMode === De.live,
                    ...
                    if (ur && !e && !qr(this._betas, Mr.acknowledge_ie9_deprecation)) throw window.console && console.error(t), new Se(t)
                }
            }, {
                key: "_ensureHTTPS",
                value: function() {
                ...
                value: function(e) {
                    //if (!e) throw this._controller.report("user_error.self_hosted"), new Se("Stripe.js must be loaded from js.stripe.com. For more information https://stripe.com/docs/stripe-js/reference#including-stripejs")
                }
            }, {
                key: "_mids",
                value: function() {
    ...
    ac.version = 3, ac.stripeJsId = Ht(), ac._ec = function() {
        return "https://checkout.stripe.com/".match(new RegExp(document.location.protocol + "//" + document.location.host)) ? null : new Oa
    }();
    var sc = function() {
            var e = this;
            this.elements = on(function(t) {
                return new ea(e._controller, nc({}, e._locale ? {
                    locale: e._locale
                } : {}, t, {
                    betas: e._betas
                }))
            }), this.createToken = an(function(t, n) {
                var r = e._mids();
                if ("cvc_update" === t) {
                    if (qr(e._betas, Mr.cvc_update_beta_1)) return Xs(e._controller, n, r);
                    throw new Se("You cannot create a 'cvc_update' token without using the 'cvc_update_beta_1' beta flag.")
                }
                return Zs(e._controller, r)(t, n)
            }), this.createSource = an(function(t, n) {
                var r = Ta(t),
                    o = ts(r ? n : t),
                    i = o || {
                        type: null,
                ...
                if (r) {
                    var c = r._frame.id,
                        u = r._componentName;
                    return !o && ya(u) ? Te.reject(new Se("Please provide Source creation parameters to createSource.")) : e._controller.action.createSourceWithElement({
                        frameId: c,
                        elementName: u,
                        type: a,
                        sourceData: s,
                ...
                return o ? a ? e._controller.action.createSourceWithData({
                    ...
                    sourceData: s,
                    mids: e._mids()
                }).then(ns) : Te.reject(new Se("Please provide a source type to createSource.")) : Te.reject(new Se("Please provide either an Element or Source creation parameters to createSource."))
            }), this.retrieveSource = on(function(t) {
                var n = yt(os, {
                        source: t
                    }, "retrieveSource"),
                    r = n.value;
                return n.warnings.forEach(function(t) {
                    return e._controller.warn(t)
                }), e._controller.action.retrieveSource(r).then(ns)
            }), this.paymentRequest = an(function(t, n) {
                Fe(e._keyMode);
                var r = e._isCheckout && n ? n : null;
                return na(e._controller, {
                    apiKey: e._apiKey,
        ...
        cc = ac,
        uc = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
        } : function(e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        },
        ...
        pc = function() {
            if (document.currentScript) {
                var e = gt(document.currentScript.src);
                return !e || $n(e.origin)
            }
            return !0
        }(),
        dc = function(e, t) {
            return new cc(lc({
                apiKey: e
            }, t && "object" === (void 0 === t ? "undefined" : uc(t)) ? t : {}), pc)
        };
    dc.version = cc.version, window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3 ? window.Stripe.StripeV3 = dc : window.Stripe ? window.console && console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page.") : window.Stripe = dc;
    t.default = dc
}, function(e, t, n) {
    "use strict";
